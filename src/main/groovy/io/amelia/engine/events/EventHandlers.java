...
import io.amelia.foundation.RegistrarContext;
...
public class EventHandlers extends AbstractList<RegisteredListener>
{
	 ...
	 */
	public static void unregisterAll( RegistrarContext registrar )
	{
		synchronized ( handlers )
		{
			for ( EventHandlers handler : handlers )
	 ...
	 */
	public synchronized void unregister( RegistrarContext registrar )
	{
