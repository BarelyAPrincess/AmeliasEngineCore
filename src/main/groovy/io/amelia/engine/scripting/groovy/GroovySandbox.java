...
public class GroovySandbox extends CompilationCustomizer
{
	...
	private class SecuringCodeVisitor implements GroovyCodeVisitor
	{
		 ...
		 *
		 * @throws SandboxSecurityException if usage of this expression class is forbidden
		 */
		 ...
		 *
		 * @throws SandboxSecurityException if usage of this statement class is forbidden
		 */
		 ...
		 *
		 * @throws SandboxSecurityException if usage of this token is forbidden
		 */
