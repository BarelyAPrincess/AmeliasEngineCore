...
public class Triplet<L, M, R> implements Comparable<Triplet<L, M, R>>, Serializable
{
	 ...
	 */
	@Override
	public int compareTo( final io.amelia.support.Triplet<L, M, R> other )
	{
	...
	public boolean equals( final Object obj )
	{
		...
		if ( obj instanceof io.amelia.support.Triplet )
		{
			final io.amelia.support.Triplet<?, ?, ?> other = ( io.amelia.support.Triplet ) obj;
