...
class EscapeTranslator
{
	...
	{
		return new io.amelia.support.EscapeTranslator( BASIC_ESCAPE );
	}
	...
	{
		return new io.amelia.support.EscapeTranslator( ISO8859_1_ESCAPE, HTML_ESCAPE );
	}
	...
	{
		return new io.amelia.support.EscapeTranslator( ISO8859_1_ESCAPE );
	}
	...
	{
		return new io.amelia.support.EscapeTranslator( JAVA_CTRL_CHARS_ESCAPE );
	}
