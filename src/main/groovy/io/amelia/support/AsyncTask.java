...
{
	private static final Kernel.Logger L = Kernel.getLogger( io.amelia.support.AsyncTask.class );
	...
	{
		synchronized ( io.amelia.support.AsyncTask.class )
		{
			if ( receiver == null )
				receiver = msg -> {
	 ...
	 *                               {@link io.amelia.support.AsyncTask.Status#RUNNING} or {@link io.amelia.support.AsyncTask.Status#FINISHED}.
	 ...
	 * @throws IllegalStateException If {@link #getStatus()} returns either
	 *                               {@link io.amelia.support.AsyncTask.Status#RUNNING} or {@link io.amelia.support.AsyncTask.Status#FINISHED}.
	 * @see #execute(Executor, Object[])
	 */
	public final io.amelia.support.AsyncTask<Params, Progress, Result> executeParallel( Params... params )
	{
	 ...
	 * @see #execute(Executor, Object[])
	 */
	public final io.amelia.support.AsyncTask<Params, Progress, Result> executeSerial( Params... params )
	{
	...
	public enum Status
	{
		...
		RUNNING,
		/**
		 * Indicates that {@link io.amelia.support.AsyncTask#onPostExecute} has finished.
		 */
		FINISHED,
	}
	...
	{
		final Data[] mData;
		final io.amelia.support.AsyncTask mTask;

		@SafeVarargs
		AsyncTaskResult( io.amelia.support.AsyncTask task, Data... data )
		{
			mTask = task;
			mData = data;
		}
